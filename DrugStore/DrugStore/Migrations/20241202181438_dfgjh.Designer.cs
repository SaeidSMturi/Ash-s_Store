...
namespace DrugStore.Migrations
{
    ...
    [Migration("20241202181438_dfgjh")]
    partial class dfgjh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrugStore.Data.Entities.Product.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrugStore.Data.Entities.Product.OrderDetail", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrugStore.Data.Entities.Product.OrderStatus", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrugStore.Data.Entities.Product.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrugStore.Data.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDelete = false,
                            IsEmailActive = true,
                            LastChange = new DateTime(2024, 12, 2, 21, 44, 37, 717, DateTimeKind.Local).AddTicks(9239),
                            LastName = "",
                            Password = "pmWkWSBCL51Bfkhn79xPuKBKHz//H6B+mY6G9/eieuM=",
                            RegisterDate = new DateTime(2024, 12, 2, 21, 44, 37, 717, DateTimeKind.Local).AddTicks(9249),
            ...
            modelBuilder.Entity("DrugStore.Data.Entities.Product.Order", b =>
                {
                    b.HasOne("DrugStore.Data.Entities.Product.OrderStatus", "OrderStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("DrugStore.Data.Entities.Product.OrderDetail", b =>
                {
                    b.HasOne("DrugStore.Data.Entities.Product.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DrugStore.Data.Entities.Product.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("DrugStore.Data.Entities.Product.Product", b =>
                {
                    b.HasOne("DrugStore.Data.Entities.Product.OrderStatus", null)
                        .WithMany("Products")
                        .HasForeignKey("OrderStatusStatusId");

                    b.HasOne("DrugStore.Data.Entities.User.User", null)
                        .WithMany("Products")
                        .HasForeignKey("UserId");
                });
